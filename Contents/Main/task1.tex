...
\ssssection{\textbf{aaaaaaaaaaaaaaaa}}
...
\subsubsection{Cho toàn bộ hệ thống} 
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[scale=0.7]{Task1/Use case diagram.png} 
...
\begin{center}
    \begin{tabular}{|c|l|m{7cm}|} \hline 
         ...
         \xrowht{30pt}   UC006  & Kiểm tra và điều hướng trạng thái bãi xe & Hệ thống thu thập dữ liệu từ cảm biến và IoT Gateway để hiển thị trạng thái bãi xe (còn chỗ, gần đầy, hết chỗ) và hỗ trợ điều hướng.\\  \hline 
        \xrowht{30pt}   UC007   & Cấu hình chính sách giá và quyền lợi gửi xe      & Quản trị viên thiết lập hoặc điều chỉnh chính sách giá và quyền lợi gửi xe cho từng nhóm người dùng. \\ \hline
         ...
         \xrowht{30pt}   UC009   & Giám sát và đồng bộ dữ liệu & Hệ thống giám sát trạng thái các cảm biến, gateway và đồng bộ dữ liệu với HCMUT DATACORE để đảm bảo tính nhất quán. \\  \hline
         \xrowht{30pt}   UC010   & Xử lý sự cố tại chỗ & Nhân viên tiếp nhận phản ánh sự cố từ người dùng (ví dụ: mất thẻ, lỗi cổng, lỗi thanh toán), ghi nhận sự cố vào hệ thống và gửi thông báo đến quản trị viên để kiểm tra và xử lý. \\  \hline
    \end{tabular}
\end{center}
...
\input{Contents/Main/usecase/1-Login}

\newpage

\ssssection{Bảng mô tả usecase Quẹt thẻ nội bộ}

\input{Contents/Main/usecase/2-quetthenoibo}
...
\input{Contents/Main/usecase/3-quetthevanglai}
...
\input{Contents/Main/usecase/4-thanhtoantaicho}
...
\input{Contents/Main/usecase/5-thanhtoantratruoc}

\vspace{1cm}

\newpage

\ssssection{Bảng mô tả usecase Kiểm tra và điều hướng trạng thái bãi xe}


\input{Contents/Main/usecase/6-kiemtravadieuhuong}
...
\input{Contents/Main/usecase/7-cauhinhchinhsachgia}
...
\input{Contents/Main/usecase/8-thongkevaxuatbaocao}

\newpage


\ssssection{Bảng mô tả usecase Giám sát và đồng bộ dữ liệu}

\input{Contents/Main/usecase/9-giamsatvadongbo}

\ssssection{Bảng mô tả usecase Xử lý sự cố tại chỗ}

\input{Contents/Main/usecase/10-xulysuco}